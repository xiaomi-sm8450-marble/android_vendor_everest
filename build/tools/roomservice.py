...
if not depsonly:
    print("Device %s not found. Attempting to retrieve device repository from EverestOS Github (http://github.com/ProjectEverest)." % device)
...
def get_default_or_fallback_revision(repo_name):
    ...
    githubreq = urllib.request.Request("https://api.github.com/repos/ProjectEverest/" + repo_name + "/branches")
    add_auth(githubreq)
